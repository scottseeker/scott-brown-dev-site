(function(){
    ...
    describe('stsApp.timebar directive', function() {
      var $compile,
      $rootScope,
      elm,
      scope;
      ...
      it('Replaces timebar element with directive, contains expected html',  function() {
        scope = $rootScope.$new();
        elm = angular.element('<span timebar></span>');
        $compile(elm, scope);
        scope.$apply();                       
        // Check that the compiled element contains the templated content
        expect(elm.html()).toContain('<ul id="timebar-list">');        
      });
